//
//  ComputerListTableViewController.m
//  Navigation App
//
...
@interface ComputerListTableViewController ()

@end

@implementation ComputerListTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cellLabel.text = self.computers[indexPath.row];
    return cell;
}

- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ComputerDetailViewController *destination = segue.destinationViewController;
